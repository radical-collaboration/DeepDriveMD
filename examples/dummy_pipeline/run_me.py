...
async def run_ddmd(backend='rp', simulation_cores=16, train_cores=1):
    ...
    workflow = DummyWorkflow(asyncflow=asyncflow, training_cores=train_cores, max_sim_batch=simulation_cores)
...
# python run_me.py --backend rp --simulation_cores 4 --train_cores

# dragon run_me.py --backend dragon --simulation_cores 4 --train_cores
