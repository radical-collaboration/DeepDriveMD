...
from MD_utils.openmm_simulation import openmm_simulate_memb_explicit # openmm_simulate_amber_fs_pep 

parser = argparse.ArgumentParser()
parser.add_argument("-f", "--pdb_file", dest="f", help="pdb file")
parser.add_argument("-p", "--topol", dest='p', help="topology file")
parser.add_argument("-c", "--check_pnt", dest='c', help="check point file to restart simulation")
...
# check_point = None
openmm_simulate_memb_explicit(pdb_file, top_file, 
